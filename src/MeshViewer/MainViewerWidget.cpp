...
void MainViewerWidget::CreateParamWidget(void)
{
	...
	connect(meshparamwidget, SIGNAL(DoTuttleSignal()), meshviewerwidget, SLOT(DoTuttleFlatten()));
	connect(meshparamwidget, SIGNAL(DoFloaterSignal()), meshviewerwidget, SLOT(DoFloaterFlatten()));
	connect(meshparamwidget, SIGNAL(ChangeBoundaryTypeSignal(int)), meshviewerwidget, SLOT(ChangeBoundaryType(int)));
	connect(meshparamwidget, SIGNAL(DoARAPOptSignal()), meshviewerwidget, SLOT(DoARAPOpt()));
	connect(meshparamwidget, SIGNAL(DoSDOptSignal()), meshviewerwidget, SLOT(DoSDOpt()));
	connect(meshparamwidget, SIGNAL(DoLSCMSignal()), meshviewerwidget, SLOT(DoLSCM()));
	connect(meshparamwidget, SIGNAL(DoDOFSignal()), meshviewerwidget, SLOT(DoDOF()));
}
